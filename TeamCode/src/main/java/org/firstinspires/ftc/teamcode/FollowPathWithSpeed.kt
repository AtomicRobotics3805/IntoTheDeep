 ...
 */
class FollowPathWithSpeed(val path: PathChain, val holdEnd: Boolean = false, val maxPower: Double = 1.0): Command() {
    ...
    override fun start() {
        ...
        PedroData.follower!!.setMaxPower(maxPower)
        PedroData.follower!!.followPath(path, holdEnd)
    }

    override fun stop(interrupted: Boolean) {
        PedroData.follower!!.setMaxPower(1.0)
    }
}