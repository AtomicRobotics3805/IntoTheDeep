...
// Modified 7/5/2024 by John Courter
//
/**
 ...
 * @version 1.0.1
 */
public class DotStarLEDNew {

    /* Declare OpMode members. */
    private LinearOpMode myOpMode = null;   // gain access to methods in the calling OpMode.

    public DigitalChannel clock = null;
    public DigitalChannel data  = null;

    public DotStarLEDNew (LinearOpMode opmode) {
        myOpMode = opmode;
    }
    ...
    public void init(int numLEDs) {
        ...
        clock.setMode(DigitalChannel.Mode.OUTPUT);
        data.setMode(DigitalChannel.Mode.OUTPUT);

        // Prepare memory for the array of pixels.
        length = numLEDs;
        pixels = new Pixel[numLEDs];
        colors = new int[numLEDs * 3];
    ...
    public void setClockPin(String ClockPinName) {
        clock = myOpMode.hardwareMap.get(DigitalChannel.class, ClockPinName);
    }
    public void setDataPin(String DataPinName) {
        data = myOpMode.hardwareMap.get(DigitalChannel.class, DataPinName);
    }
    ...
    public void update() {
        ...
        // This will be written out to the digital channels once filled.
